...
class LLMAPI(sampler.LLM):
    ...
    def __init__(self, samples_per_prompt: int):
        ...
        additional_prompt = (
            'Please modify the ADMM optimizer in the provided regularized l1 function to incorporate an unfixed penalty parameter. Specifically, the penalty parameter mu should be adjusted dynamically during each iteration based on the current optimization state, rather than being fixed. '
