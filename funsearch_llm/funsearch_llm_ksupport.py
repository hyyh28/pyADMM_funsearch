...
def evaluate(instances: dict) -> float:
    ...
    # Options for k-support norm minimization
    opts = instances
    k = instances['k']
...
if __name__ == '__main__':
    ...
    admm_ksupport_config = admm_utils.datasets['ksupport']
    global_max_sample_num = 10
    # if it is set to None, funsearch will execute an endless loop
    funsearch.main(
        specification=specification,
        inputs=admm_ksupport_config,
        config=config,
        max_sample_nums=global_max_sample_num,
        class_config=class_config,
        log_dir='logs/sparse_models/ksupport/funsearch_ksupport_100',
        temperature=0
    )