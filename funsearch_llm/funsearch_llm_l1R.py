...
def evaluate(instances: dict) -> float:
    ...
    # Options for l1 regularization
    opts = instances
    
    # Perform l1 regularization minimization
    X, E, obj, err, iter = l1R(A, B, lambd, opts)
...
if __name__ == '__main__':
    ...
    admm_l1R_config = admm_utils.datasets['l1R']
    ...
    funsearch.main(
        ...
        log_dir='logs/sparse_models/l1R/funsearch_l1R',
        temperature=0
    )