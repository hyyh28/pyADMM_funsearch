...
def evaluate(instances: dict) -> float:
    ...
    lambd = instances['lambda_val']

    # Options for group l1 regularization
    opts = instances
    
    # Perform group l1 regularization minimization
    X, E, obj, err, iter = groupl1R(A, B, G, lambd, opts)
