...
def evaluate(instances: dict) -> float:
    ...
    B = A @ X
    lambd1 = instances['lambda1']
    lambd2 = instances['lambda2']
    # Options for the LRSR minimization
    opts = instances
    # Perform LRSR minimization
    Xhat, Ehat, obj, err, iter = lrsr(A, B, lambd1, lambd2, opts)
...
if __name__ == '__main__':
    ...
    lrsr_config = admm_utils.datasets['lrsr'] 
...
<<<<<<< Updated upstream
        log_dir='logs/low_rank_matrix_models/lrsr/funsearch_lrsr',
=======
        log_dir='logs/low_rank_matrix_models/lrsr/funsearch_lrsr_100',
>>>>>>> Stashed changes
        temperature=0
    )