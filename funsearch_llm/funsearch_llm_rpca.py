...
def evaluate(instances:dict) -> float:
    ...
    print(f'Iterations: {iter}, Relative error L: {rel_err_L}, Relative error S: {rel_err_S}, Error: {err}')
...
if __name__ == '__main__':
    ...
    rpca_config = admm_utils.datasets['rpca']
...
<<<<<<< Updated upstream
        log_dir='logs/low_rank_matrix_models/rpca/funsearch_rpca',
=======
        log_dir='logs/low_rank_matrix_models/rpca/funsearch_rpca_100',
>>>>>>> Stashed changes
        temperature=0
    )
