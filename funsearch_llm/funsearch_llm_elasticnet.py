...
def prox_elasticnet(b, lambd1, lambd2):
    # The proximal operator of the elastic net
    return (np.maximum(0, b - lambd1) + np.minimum(0, b + lambd1)) / (lambd2 + 1)
...
def evaluate(instances:dict) -> float:
    ...
    X2, obj, err, iter = elasticnet(A, B, lambd, opts)
