...
def evaluate_multiple(instances: dict, num_trials: int = 10) -> float:
    total_iterations = 0
    for _ in range(num_trials):
        total_iterations += evaluate(instances)
    
    average_iterations = total_iterations / num_trials
    print(f'Average Iterations over {num_trials} trials: {average_iterations}')
