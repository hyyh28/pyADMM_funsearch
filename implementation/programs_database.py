    ...
    def _generate_prompt(
        ...
        header = dataclasses.replace(
            ...
            docstring=('Improved version of '
                    #    f'`{self._function_to_evolve}_v{next_version - 1}`.'+'.This function should be different from previous functions,and must include return value.Do not generate same function and code annotation.'+'\n    Args:\n        item: Size of item to be added to the bin.\n        bins: Array of capacities for each bin.\n\n    Return:\n        Array of same size as bins with priority score of each bin.\n    '),
