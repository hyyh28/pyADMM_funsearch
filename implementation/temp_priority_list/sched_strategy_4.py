...
def priority(bin, item):
    ...
    You should consider the following factor which may be helpful to optimize the result.The factors are "initial_size_pyhsical_machine","capacity_dict" and "flavor_types".
